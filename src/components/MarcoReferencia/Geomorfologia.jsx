...
const Geomorfologia = () => {
    return (
        <section className="Marco_referencia_section">
            <h2 className="MarcoReferencia_title">Geomorfología</h2>
            <p className="MarcoReferencia_paragraph">El Municipio de La Unión se localiza en el flanco oriental de la cordillera central, en la parte superior de la cuenca del Río Buey. Sobresalen algunas alturas orográficas como el Alto del Chaquiro (2.400 m.s.n.m), el Cerro Mula (2.700 m.s.n.m) y el Alto del Precipicio (2.600 m.s.n.m).</p>
